...
(function () {
  ...
  function createFotonT1Modal() {
    ...
    loadVimeoScript().then(() => initializeVimeoPlayers(desktopIframe, mobileIframe)).then(() => {
  ...
  (function kamT1FotonV1() {
    ...
    Kameleoon.API.Core.runWhenElementPresent(kamT1FotonConfig.selectors.triggerSelector, kamT1FotonInit);
  })();
})();