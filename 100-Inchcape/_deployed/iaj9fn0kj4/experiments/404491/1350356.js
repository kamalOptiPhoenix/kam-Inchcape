...
(function () {
  ...
  function restyleGallery() {
    ...
    const slidesHtml = uniqueImages.map(({
      src,
      alt
    }) => `
...
<div class="kgmt5-sec7-btn-wrapper">
  ...
  (function kamKgmt5V1() {
    function initSection7Carousel() {
      ...
      Kameleoon.API.Utils.addEventListener(scrollEl, 'scroll', updateArrowStates, {
        passive: true
      });
    ...
    function init() {
      ...
      Kameleoon.API.Core.runWhenConditionTrue(() => typeof window.Swiper !== 'undefined' && document.querySelector('.kgmt5-gallery-swiper'), initGallerySwiper);
    }
