...
`;
  ...
  (function kamT5DeepalV1() {
    ...
    if (!window.deet5newstart) {
      ...
      Kameleoon.API.Core.runWhenConditionTrue(() => document.getElementById('tecnologiaVehiculos_Design') || document.getElementById('tecnologiaVehiculos_Interior'), () => init('v1'));
    }
  })();
})();