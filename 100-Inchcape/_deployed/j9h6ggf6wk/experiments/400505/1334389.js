  ...
  const kamT5DeepalConfig = {
    ...
    modalConfigs: {
      S07: {
        ...
        actions: {
          brochure: {
            desktopImage: '//cdn.optimizely.com/img/15841360337/f0330ddf90e84336baa0e4f3d14f433b.jpg',
            mobileImage: '//cdn.optimizely.com/img/15841360337/216a5599e38f4d889aa773577bd6d033.jpg',
            href: 'javascript:void(0);',
            target: '_self'
          },
          testDrive: {
            desktopImage: '//cdn.optimizely.com/img/15841360337/9be7d20a7ca44a3491ba026ac00f0b2f.png',
            mobileImage: '//cdn.optimizely.com/img/15841360337/e60808b49f23474daa26375133e2dc87.png',
            href: 'https://www.deepal.com.au/buying-tools/book-a-test-drive/',
            target: '_self'
          },
          quote: {
            desktopImage: '//cdn.optimizely.com/img/15841360337/03190cd6dbc4415ea379bc376dda7e80.png',
            mobileImage: '//cdn.optimizely.com/img/15841360337/4ecc2e3690554f85977b5c8368ec292c.png',
      ...
      E07: {
        ...
        actions: {
          brochure: {
            desktopImage: '//cdn.optimizely.com/img/15841360337/6e75b34f90a14ec3b0ef1dd6f1c61b5d.png',
            mobileImage: '//cdn.optimizely.com/img/15841360337/aa458c2f68f649df992b9b2bfa1b8bf5.png',
            href: 'https://www.deepal.com.au/media/u1slviml/deepal_e07_spec_sheet_lr-r.pdf',
            target: '_blank'
          },
          testDrive: {
            desktopImage: '//cdn.optimizely.com/img/15841360337/8e606d7f516e40ac804f356a6d68e3c8.png',
            mobileImage: '//cdn.optimizely.com/img/15841360337/99e714aabf3e49a1aaea3c1b14c3dd86.png',
            href: 'https://www.deepal.com.au/buying-tools/book-a-test-drive/',
            target: '_self'
          },
          quote: {
            desktopImage: '//cdn.optimizely.com/img/15841360337/f885479677d44f30a73750298880ddfe.png',
            mobileImage: '//cdn.optimizely.com/img/15841360337/05940b4a1aab4145b4e64a1882f96a08.png',
            href: 'https://www.deepal.com.au/buying-tools/get-a-quote/',
            target: '_self'
          }
        }
...
`;
  ...
  function kamT5DeepalProcessGoal(goalName) {
  ...
  function detectCarModel() {
    ...
    if (interiorElement) return {
      element: interiorElement,
      model: 'E07'
    };
    return null;
  }
  ...
  function handleSliderInteractions() {
  ...
  function checkExitIntent() {
    if (window.innerWidth < 768 && !document.body.classList.contains('t5-slide-up-animation')) {
      mobileScrollEvent();
    } else {
      Kameleoon.API.Utils.addEventListener(document, 'mouseleave', event => {
        if (event.clientY < 5 && !document.body.classList.contains('t5-slide-up-animation')) {
  ...
  (function kamT5DeepalV2() {
    ...
    if (!window.deet5newstart) {
      ...
      Kameleoon.API.Core.runWhenConditionTrue(() => document.getElementById('tecnologiaVehiculos_Design') || document.getElementById('tecnologiaVehiculos_Interior'), () => init('v2'));
    }
  })();
})();