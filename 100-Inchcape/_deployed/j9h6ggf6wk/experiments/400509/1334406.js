    ...
    return `
        <div class="deet6-butter-bar deet6-butter-bar-visible" id="deet6-butter-bar">
            ...
            <div class="deet6-bottom-row">
                <a href="https://www.deepal.com.au/#HomeSubscriptionForm" class="deet6-cta-btn deet6-newsletter">
                    <img class="deet6-butterbar-icon" src="//cdn.optimizely.com/img/15841360337/2e6d9ebc0fad40718d1333ebe86fa63d.svg" alt="Special Offers Icon" />
                  <span class="desktop-text">Newsletter</span>
                  <span class="mobile-text">Join our Newsletter</span>
                </a>
            </div>
        </div>
    `;
