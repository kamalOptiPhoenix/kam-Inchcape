...
(function () {
  const goals = {
    'Contact Details conversions T1': 423367,
    'Pop-up appearances T1': 423363
  };
  function kamLdvt1ProcessGoal(goalName) {
...
`,
    ...
    clickBind: () => {
      const brochure_T1_form = document.querySelector('.brochure_T1_form_wrapper form');
      Kameleoon.API.Utils.addEventListener(brochure_T1_form, 'submit', event => {
      ...
      Kameleoon.API.Utils.addEventListener(document.querySelector('.brochure_T1'), 'click', event => {
    ...
    changeFormStyle: () => {
      const brochure_form = document.querySelector('.brochure_T1_form_wrapper form');
  ...
  function init() {
    ...
    if (!document.querySelector('.brochureModal')) {
      ...
      config.fetchForm().then(form => {
        const brochure_T1_form_wrapper = document.querySelector('.brochure_T1_form_wrapper');
