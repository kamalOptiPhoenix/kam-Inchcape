...
(function () {
  ...
  function setupModalEvents(config) {
  ...
  const goals = {
    'Modal PageViews T7': 423538
  };
  function kamLdvt7ProcessGoal(goalName) {
  ...
  function preloadImages(modelName, models) {
    return new Promise((resolve, reject) => {
      ...
      const isMobile = window.innerWidth <= 768;
      const images = isMobile ? model.mobile : model.desktop;
      const imageUrls = [images.priceList, images.testDrive, images.brochure, '//cdn.optimizely.com/img/15841360337/2998c12530b0478f85239cc982388a33.svg', '//cdn.optimizely.com/img/15841360337/790168dad33a4cb388bf1ebdae8e28dc.svg', '//cdn.optimizely.com/img/15841360337/e9c7afc859b84afb9a7db1d6d7564a72.svg'];
      let loadedCount = 0;
  ...
  function setupViewportWatcher(config, modelName) {
    const functionalityElement = Array.from(document.querySelectorAll(config.selectors.functionalitySection)).find(el => el.textContent.trim() === config.selectors.functionalityText) || document.querySelector(config.selectors.gallerySection);
    ...
    function checkViewport() {
      ...
      if (isElementInViewport(functionalityElement)) {
        ...
        preloadImages(modelName, T60_MODELS).then(() => {
  ...
  (function kamLdvt7V1() {
    ...
    if (!window.v1Start && !sessionStorage.getItem(config.sessionStorageKey) && !sessionStorage.getItem('T7_slideup_popup')) {
      ...
      Kameleoon.API.Core.runWhenConditionTrue(() => {
        ...
        const functionalityMatch = Array.from(document.querySelectorAll(config.selectors.functionalitySection)).find(el => el.textContent.trim() === config.selectors.functionalityText);
