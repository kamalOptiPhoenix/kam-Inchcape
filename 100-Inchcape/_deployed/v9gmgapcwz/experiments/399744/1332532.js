...
<div class="pcat68-col-second">
  ...
  <div class="pcat68-thankyou-wrap">
    ...
    init: variation => {
      ...
      if (variation === 'v1') {
        ...
        if (trimDetailsSecondaryColumn) {
          const modelnameEl = document.querySelector('.trimDetailsOfferBox .tdOfferBoxItem.tdOfferBoxItemModel .tdOfferBoxItemText');
    ...
    bindEvents: rootEl => {
      ...
      submitBtn.addEventListener('click', e => {
        ...
        submitDealerEnquiry(nameVal, phoneVal).then(response => {
  ...
  (function kamPcat68V2() {
    if (!window.t68Start) {
      ...
      Kameleoon.API.Core.runWhenConditionTrue(() => document.querySelector('body.build-buy-summary') !== null && document.querySelector('.trimDetailsWrapper .trimDetailsSecondaryColumn') !== null, () => {
