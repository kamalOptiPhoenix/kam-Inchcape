...
(function () {
  ...
  function kamPcat70WarrantyConfig() {
    const commercialIds = ['trim-1216', 'trim-1198', 'trim-1209', 'trim-1203', 'trim-3478', 'trim-3483', 'trim-3475', 'trim-3484', 'trim-3482', 'trim-3481', 'trim-3283', 'trim-3486', 'trim-3116', 'trim-3117', 'trim-3118', 'trim-3119', 'trim-2410', 'trim-1197', 'trim-3417'];
    const passengerIds = ['trim-2688', 'trim-2689', 'trim-2529', 'trim-2535', 'trim-2802', 'trim-2803', 'trim-2635', 'trim-2654'];
    ...
    function buildContent(type) {
      ...
      const warrantyText = isCommercial ? `5 Year/200,000km Warranty ${isMobile ? '&' : '&<br>'} 5 Years Roadside Assistance` : `5 Year Warranty ${isMobile ? '&' : '&<br>'} 5 Years Roadside Assistance`;
      return `
    ...
    function getWarrantyDetails(type) {
      return type === 'commercial' ? '5 Year/200,000 Kilometre Warranty, whichever occurs first on PEUGEOT commercial vehicles.' : '5 Year Unlimited Kilometre Warranty on PEUGEOT passenger vehicles.';
    }
    function getRoadsideDetails(type) {
      return type === 'commercial' ? '5 Year Roadside Assistance on PEUGEOT commercial vehicles.' : '5 Year Roadside Assistance on PEUGEOT vehicles.';
    }
    const commercialNames = ['Partner', 'Expert', 'Boxer', 'E-Partner', 'E-Expert'];
  ...
  (function kamPcat70V1() {
    ...
    if (!window.v1Start) {
      window.v1Start = true;
      Kameleoon.API.Core.runWhenConditionTrue(() => document.querySelector('#listing-wrapper') || document.querySelector('.trimDetailsOfferBox'), init);
    }
  })();
})();