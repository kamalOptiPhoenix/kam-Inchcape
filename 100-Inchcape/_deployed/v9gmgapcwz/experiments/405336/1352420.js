...
(function () {
  function kamT69InitCarSelection() {
    ...
    const carBoxes = document.querySelectorAll('.row .small-12.medium-3.columns');
    ...
    carBoxes.forEach(box => {
      ...
      const ctaBtn = box.querySelector('a.q-button.button.primary.q-mod.q-mod-button-link.stat-button-link.center.analytics');
  ...
  (function kamPcat69V1() {
    ...
    if (!window.v1Start) {
      window.v1Start = true;
      Kameleoon.API.Core.runWhenConditionTrue(() => document.body !== null, init);
    }
  })();
})();