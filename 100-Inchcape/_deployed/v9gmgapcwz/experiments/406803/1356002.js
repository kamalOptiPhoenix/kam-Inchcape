...
(function () {
  const goals = {
    t72_contact_a_retailer: 424443,
    t72_make_a_finance_enquiry: 424442
  };
  function kamPcat72ProcessGoal(goalName) {
  ...
  const PCAT72_MODEL_CONFIG = {
    '2008-hybrid-suv': {
      ...
      getTargetElement: () => {
        const heading = [...document.querySelectorAll('h2')].find(el => el.textContent.trim() === 'UNMISTAKABLY PEUGEOT');
    ...
    '3008-hybrid-suv': {
      ...
      getTargetElement: () => {
        const photolink = [...document.querySelectorAll('a.wlb-button-wrapper--element')].find(el => el.textContent.trim() === 'VIEW PHOTOS & VIDEOS');
    ...
    '5008-hybrid-suv': {
      ...
      getTargetElement: () => {
        const heading = [...document.querySelectorAll('h2')].find(el => el.textContent.trim() === 'CHOOSE YOUR PEUGEOT 5008 HYBRID');
    ...
    '308-hybrid': {
      ...
      getTargetElement: () => {
        const heading = [...document.querySelectorAll('h2')].find(el => el.textContent.trim() === 'CHOOSE YOUR PEUGEOT 308 HYBRID');
        return heading ? heading.closest('.grid_builder_v2.grid_builder') : null;
      }
    },
    '408-hybrid': {
      ...
      getTargetElement: () => {
        const heading = [...document.querySelectorAll('h2')].find(el => el.textContent.trim() === 'CHOOSE YOUR PEUGEOT 408 HYBRID');
        return heading ? heading.closest('.grid_builder_v2.grid_builder') : null;
      }
    },
    'partner-van': {
      ...
      getTargetElement: () => {
        const heading = [...document.querySelectorAll('h2')].find(el => el.textContent.trim() === 'DIMENSIONS OF THE PEUGEOT PARTNER');
        return heading ? heading.closest('.grid_builder_v2.grid_builder') : null;
      }
    },
    'diesel-expert-van': {
      ...
      getTargetElement: () => {
        const heading = [...document.querySelectorAll('h2')].find(el => el.textContent.trim() === 'THE MAIN ADVANTAGES OF YOUR NEW EXPERT');
        return heading ? heading.closest('.grid_builder_v2.grid_builder') : null;
      }
    },
    'boxer-van': {
      ...
      getTargetElement: () => {
        const heading = [...document.querySelectorAll('h2')].find(el => el.textContent.trim() === 'A PEUGEOT BOXER FOR EVERY JOB');
        return heading ? heading.closest('.grid_builder_v2.grid_builder') : null;
      }
    }
  };
