...
(function () {
  ...
  const domInjector = (() => {
    ...
    const inject = ({
      ...
      position = 'beforeend',
      uniqueId,
      // ✅ MUST be data attribute like [data-my-section]
      parentSelector,
    ...
    <div class="subt136-finance__content">
      ...
      <div class="subt136-finance__options">
        <div class="subt136-card">
          ...
          <p>Use your current car as a trade in and upgrade to a new Subaru. (Must meet loan approval criteria)</p>
        </div>
        ...
        <img src="//cdn.optimizely.com/img/15841360337/a782e524bb6c42828c1cd73639695bd3.svg" alt="retain icon" class="subt136-card__icon">
          ...
          <p>Pay out the loan and keep your current Subaru. We can help with finance if required.</p>
        </div>
        ...
        <img src="//cdn.optimizely.com/img/15841360337/06be72f072b8460cbd4722265d460478.svg" alt="return icon" class="subt136-card__icon">
          ...
          <p>Simply return your Subaru and have nothing more to pay. (Your car must meet the Fair Wear & Tear Guide and agreed KMs)</p>
        </div>
      </div>
...
<div class="subt136-right-column" aria-hidden="true">
 <li>
    ...
    scheduleMoveReactBlocks() {
      ...
      ['.NFhp0A6EUn', '[data-subt136-section4]', '[data-subt136-section-new-headline]', '.XdXNCvU5i3', '#cid-62675', '#cid-62676'].forEach(selector => {
    ...
    moveReactBlocks: () => {
      ...
      const headlineHost = document.querySelector('.Vo8hB_ClC_') && document.querySelector('.Vo8hB_ClC_').closest('div[id^="react_"]') || newHeadline && newHeadline.closest('div[id^="react_"]') || null;
      if (techReact && headlineHost && headlineHost.parentNode && headlineHost !== techReact && headlineHost.nextSibling !== techReact) {
      ...
      if (interiorReact && techReact && techReact.parentNode && techReact.nextSibling !== interiorReact) {
        techReact.parentNode.insertBefore(interiorReact, techReact.nextSibling);
        console.log('[subt136] moved Interior after Technology');
      } else if (interiorReact && headlineHost && headlineHost.parentNode && !techReact && headlineHost.nextSibling !== interiorReact) {
      ...
      if (reviewSection && ownership) {
        ...
        if (reviewSectionReact && ownership.parentNode && ownership.nextSibling !== reviewSectionReact) {
    ...
    featureNavOrder: ['Technology', 'Interior', 'Performance', 'Hybrid', 'Reviews', 'Design', 'Safety Systems', 'Towing', 'Accessories', 'Gallery'],
    ...
    reorderFeatureNav() {
      const roots = document.querySelectorAll('.XdXNCvU5i3');
