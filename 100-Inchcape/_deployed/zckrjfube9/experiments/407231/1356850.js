...
(function () {
  ...
  (function v1() {
    ...
    function observeExteriorChanges() {
      ...
      const exteriorSection = document.querySelector('[data-test="container:section:subaru_exterior"]') || document.querySelector('[data-test*="option:AU_EC_"]')?.closest('[data-test="options:container"]');
      if (!exteriorSection) {
        return;
      }
