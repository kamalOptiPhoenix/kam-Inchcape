...
(function () {
  ...
  (function v2() {
    ...
    const DUAL_TONE_IMAGES = ['/solterra/sol-cosmic-white-pearl-attitudeblackmica', '/solterra/sol-harbourmistgreypearl-attitudeblackmica'];
    ...
    function getDualToneState() {
      const activeExterior = document.querySelector('.B8zs1VVNh5 .lmZUVzq18T.rxD85kjvWr');
      if (!activeExterior) {
        return null;
      }
    ...
    function handleInteriorVisibility(forceUpdate = false) {
      ...
      const selectedInterior = document.querySelector('.mXQKavWful .zepKH9h2EZ.q90KDzyBIV');
      if (isDualTone) {
