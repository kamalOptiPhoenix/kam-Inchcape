...
import kamT4FotonProcessGoal from './kamT4FotonProcessGoal.js';
...
export default function showSlider() {
    if (sessionStorage.getItem(kamT4FotonConfig.sessionKey) === null) {
        ...
        const modelMapping = {
            TUNLAND: {
                Mob_dealer:
  '//cdn.optimizely.com/img/15841360337/e6ccc471163c45eb9375162262f285ee.png',
                Mob_test:
  '//cdn.optimizely.com/img/15841360337/445923616b88478ba61c9db666ce3f4b.png',
                Mob_broucher:
  '//cdn.optimizely.com/img/15841360337/d2f58b87857c4b4da65d616be42bbf05.png',
                modelName: 'TUNLAND',
                hero1:
  '//cdn.optimizely.com/img/15841360337/5d5186d0814f45f19aa011e19d860562.png',
                hero2:
  '//cdn.optimizely.com/img/15841360337/662e1bcc8c2749228ffcf30a983c4d9e.png',
                Mob_hero1:
  '//cdn.optimizely.com/img/15841360337/95fcd223e8744d4299ad00aee463c5c0.png',
                Mob_hero2:
  '//cdn.optimizely.com/img/15841360337/64b0aa19cb024095b3834141360472b5.png',
                dealer:
  '//cdn.optimizely.com/img/15841360337/08d279edca714bfdaecb85fa35b771ef.png',
                test: '//cdn.optimizely.com/img/15841360337/91126e02b6184c978242410c8b4f79b9.png',
                brochure:
  '//cdn.optimizely.com/img/15841360337/7e689ebffd6e4b7f9731800eb99b70bf.png',
            },
            AUMARK: {
                Mob_dealer:
          '//cdn.optimizely.com/img/15841360337/ce17672d8c67407ca640e4a03d6eae3f.png',
                Mob_quote:
          '//cdn.optimizely.com/img/15841360337/321fb0ad09e040dfba685a4cdbf739eb.png',
                Mob_broucher:
          '//cdn.optimizely.com/img/15841360337/1b6b7ace42be4a1e8a1a6c4ba1336d48.png',
                modelName: 'AUMARK S',
                hero1:
          '//cdn.optimizely.com/img/15841360337/3a64d4ba7e834d4294d0f44f36a98a7f.png',
                hero2: '',
                Mob_hero1:
          '//cdn.optimizely.com/img/15841360337/4848dcee74ba4f6ebd44493956a2c9a3.png',
                dealer:
          '//cdn.optimizely.com/img/15841360337/aeb6d0b583de41b0b058f843bbb8aea2.png',
                quote:
          '//cdn.optimizely.com/img/15841360337/6ad4af97bf45437689e833dbc9845966.png',
                brochure:
          '//cdn.optimizely.com/img/15841360337/bee753a6c764417ea8e82d4fb906e160.png',
            },
        };
      ...
      || (modelName ? modelName.toUpperCase() : 'MODEL');
        ...
        const brochureURLs = {
            TUNLAND:
        'https://www.fotonaustralia.com.au/media/mblmdnca/pca7713_tunland_full_spec_sheet_v6.pdf',
            AUMARK:
        'https://www.fotonaustralia.com.au/media/widhk4es/foton_aumark_s_5d15_cabchas_spec_sheet_fin-r.pdf',
        };

        const brochureURL = modelName
            ? brochureURLs[modelName]
            : 'https://www.fotonaustralia.com.au/brochure-page/';

        const helpText = isMobile
            ? `HAVE A QUESTION ABOUT THE FOTON ${displayModelName}?`
            : `WE'RE HERE TO HELP. HAVE A QUESTION ABOUT THE FOTON ${displayModelName}?`;
...
<div class="fott4-slider-actions">
    ...
    ${
    modelName === 'AUMARK'
        ? `<a href="${getQuoteURL}" target="_self" class="fott4-slider-action-block fott4-GetQuote">
      <div class="fott4-slider-action-content">
        ...
        : `<a href="${testDriveURL}" target="_self" class="fott4-slider-action-block fott4-TestDrive">
      <div class="fott4-slider-action-content">
        <div class="fott4-card-image center">
