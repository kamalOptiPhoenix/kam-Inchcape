...
import kamLdvt5ProcessGoal from './kamLdvt5ProcessGoal.js';
...
`,
    ...
    clickBind: () => {
        const brochure_T5_form = document.querySelector(
            '.brochure_T5_form_wrapper form'
        );
        ...
        Kameleoon.API.Utils.addEventListener(
            document.querySelector('.brochure_T5'),
            'click',
            (event) => {
