...
} from "./kamT64SelectModelFromUrl.js";
...
function getModelImage(modelValue) {
  const modelImages = {
    "2008 Hybrid":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/2008/my25-2008-hybrid/2008-hybrid-model-fly-out-White.png",
    "3008 Hybrid":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/3008/2024/3008-hybrid/Peugeot-MY24-3008-MHEV-Sprite-810x455--.png",
    "308 Hybrid":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/308/my25-hybrid/308-hybrid-model-fly-out-Obsession-Blue-810x455.png",
    "408 Hybrid":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/408/408-hybrid/408-hybrid-model-fly-out-Okenite-White-R.png",
    "5008 Hybrid":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/5008/2025-hybrid/5008-hybrid-model-fly-out-Ingaro-Blue-v2.png",
    "Boxer Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/boxer/2023/Boxer-LWB-810x455-White-R2.png",
    "E-Expert Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/expert/e-expert/Model-fly-out-810x455-E-Expert.png",
    "E-Partner Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/partner/my25-e-partner/my25-peugeot-e-partner-electric-van-810x455.png",
    "Expert Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/expert/2025-diesel/expert-facelift-model-fly-out-ice-white-v2.png",
    "New Boxer Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/boxer/2023/Boxer-LWB-810x455-White-R2.png",
    "New E-Partner Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/partner/my25-e-partner/my25-peugeot-e-partner-electric-van-810x455.png",
    "New Partner Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/partner/my25-ice/Partner-ICE-Models-Web-810x455-White-R.png",
    "Partner Van":
      "https://www.peugeot.com.au/content/dam/peugeot/australia/models/partner/my25-ice/Partner-ICE-Models-Web-810x455-White-R.png",
  };

  return (
    modelImages[modelValue] ||
    "https://www.peugeot.com.au/content/dam/peugeot/australia/models/5008/2025-hybrid/5008-hybrid-model-fly-out-Ingaro-Blue-v2.png"
  ); // Default to 5008 Hybrid
}
...
function getCurrentModel() {
  ...
  if (modelName) {
    ...
    const mappedModel = mapModelNameToValue(modelName);
...
function updateFormHeader() {
  ...
  if (heading)
    heading.textContent = `QUESTION ABOUT THE PEUGEOT ${currentModel.toUpperCase()}?`;
  if (description)
    description.textContent = `Send your questions about the PEUGEOT ${currentModel}, and your local PEUGEOT dealer will get in touch.`;
...
export default function kamT64ModifyForm() {
  ...
  if (modelField) {
    // Set the model value
    const modelOption = modelField.querySelector(
  ...
  let header = document.querySelector(".t64-form-header");
  if (!header) {
    const headerHTML = `
...
function createTwoColumnLayout() {
  ...
  const firstNameWrapper = form
    .querySelector("#firstName")
    ?.closest(".imf-input-wrapper");
  const lastNameWrapper = form
...
function setupDealerDropdown() {
  ...
  function checkPostcode() {
    ...
    const isValidPostcode = /^(0[289][0-9]{2})|([1-9][0-9]{3})$/.test(
      postcodeValue
    );
    ...
    if (isValidPostcode && postcodeValue.length === 4) {
      ...
      if (
        dealerWrapper.querySelector("select") ||
        dealerWrapper.querySelector(".imf-input-wrapper")
      ) {
  ...
  document.body.addEventListener("htmx:afterSwap", function (event) {
    if (
      event.target &&
      (event.target.id === "dealer-wrapper" ||
        event.target.closest("#dealer-wrapper"))
    ) {
      setTimeout(() => {
        checkPostcode();
      }, 200);
...
function setupFormValidation() {
  ...
  function getAllRequiredFieldValues() {
    ...
    const privacyCheckbox =
      document.querySelector("#privacyPolicy\\.checkbox") ||
      document.querySelector('input[name="privacyPolicy"]');
  ...
  function validateField(field, fieldType, forceShow = false) {
    ...
    switch (fieldType) {
      ...
      case "postcode":
        ...
        if (errorMessage && value && !isValidPostcode(value)) {
          errorMessage =
            "Please match the format requested. Valid Australian postcode";
        }
        break;
      case "dealer":
        if (!value) {
    ...
    if (fieldType === "checkbox") {
      showCheckboxError(
        field,
        !field.checked ? "This field is required" : null
      );
    } else {
  ...
  function attachFormListeners() {
    ...
    const fieldConfigs = [
      ...
      { field: emailField, type: "email", events: ["input", "change", "blur"] },
      { field: phoneField, type: "phone", events: ["input", "change", "blur"] },
      {
        field: postcodeField,
        type: "postcode",
        events: ["input", "change", "blur"],
      },
      { field: dealerField, type: "dealer", events: ["change"] },
      { field: privacyCheckbox, type: "checkbox", events: ["change", "click"] },
    ];

    fieldConfigs.forEach(({ field, type, events }) => {
  ...
  document.body.addEventListener("modelChanged", function () {
    setTimeout(() => {
      attachFormListeners();
      checkFormComplete();
      updateFormHeader();
      ...
      const hiddenField =
        form.querySelector('input[name="pcat64ModelName"]') || modelHiddenField;
      if (hiddenField) {
 ...
 */
export function modifySuccessMessage() {
...
function setupMobileLayout() {
  ...
  function reorderForMobile() {
    ...
    if (isMobile) {
      ...
      if (
        header.classList.contains("t64-mobile-reordered") &&
        originalHeaderParent
      ) {
...
function updatePrivacyCheckboxLabel() {
  ...
  if (!privacyLabel) {
    const checkbox =
      form.querySelector("#privacyPolicy\\.checkbox") ||
      form.querySelector('input[name="privacyPolicy"]');
    if (checkbox) {
      privacyLabel = checkbox
        .closest(".imf-checkbox-wrapper")
        ?.querySelector("label");
    }
  }
