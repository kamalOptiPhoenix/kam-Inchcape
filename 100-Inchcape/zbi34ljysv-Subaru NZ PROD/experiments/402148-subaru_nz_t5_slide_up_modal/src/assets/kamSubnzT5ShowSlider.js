...
import kamSubnzT5ProcessGoal from './kamSubnzT5ProcessGoal.js';
...
export default function kamSubnzT5ShowSlider() {
    if (sessionStorage.getItem('t5ModalShown') === null) {
        ...
        const modelMapping = {
            OUTBACK: {
                Mob_dealer:
            '//cdn.optimizely.com/img/15841360337/9cdbe34f47274c83b95d3be94c22804b.svg',
                Mob_quote:
            '//cdn.optimizely.com/img/15841360337/994b51dbaa454dd494f9a7c6c231fcf6.png',
                Mob_broucher:
            '//cdn.optimizely.com/img/15841360337/1057b786f17441f984e5d19209a75943.png',
                modelName: 'OUTBACK',
                hero1:
            '//cdn.optimizely.com/img/15841360337/ea62aea05400434195ac9170234e836d.png',
                hero2: '',
                Mob_hero1:
            '//cdn.optimizely.com/img/15841360337/94afd5247cc2437ea3fd4e71a451f474.png',
                dealer:
            '//cdn.optimizely.com/img/15841360337/6528d9f63ec045c9abbdfc5eed03d874.svg',
                quote:
            '//cdn.optimizely.com/img/15841360337/50c7e188aabd4bef9e551c5e8d03ca4a.png',
                brochure:
            '//cdn.optimizely.com/img/15841360337/d42333cce0fc49649e76a2e12f80d0d6.png'
            },
            CROSSTREK: {
                Mob_dealer:
                '//cdn.optimizely.com/img/15841360337/9cdbe34f47274c83b95d3be94c22804b.svg',
                Mob_quote:
                '//cdn.optimizely.com/img/15841360337/4f493c1c85064e79a39fd9308a4f1599.png',
                Mob_broucher:
                '//cdn.optimizely.com/img/15841360337/966cb81cb1c54474b25e720be2d18640.png',
                modelName: 'CROSSTREK',
                hero1:
                '//cdn.optimizely.com/img/15841360337/de37608f017548e4be940501e0fbceab.png',
                hero2: '',
                Mob_hero1:
                '//cdn.optimizely.com/img/15841360337/7f118380434d4126ac9246e881e8493d.png',
                dealer:
                '//cdn.optimizely.com/img/15841360337/6528d9f63ec045c9abbdfc5eed03d874.svg',
                quote:
                '//cdn.optimizely.com/img/15841360337/d03a9d2ee2204606b4a0e3c4e73b302d.png',
                brochure:
                '//cdn.optimizely.com/img/15841360337/57e2fd17642f49f3918e18e90af8f452.png'
            },
            FORESTER: {
                Mob_dealer:
                '//cdn.optimizely.com/img/15841360337/9cdbe34f47274c83b95d3be94c22804b.svg',
                Mob_quote:
                '//cdn.optimizely.com/img/15841360337/0b563e9b0cc64d08b4e90e77ffa43ea4.png',
                Mob_broucher:
                '//cdn.optimizely.com/img/15841360337/2d7172b389514ed98e2f4c5a189ad9fa.png',
                modelName: 'FORESTER',
                hero1:
                '//cdn.optimizely.com/img/15841360337/ece35845cae9452680e2f4962b0db752.png',
                hero2: '',
                Mob_hero1:
                '//cdn.optimizely.com/img/15841360337/e695ce7386e6496f85a2f8af92800de1.png',
                dealer:
                '//cdn.optimizely.com/img/15841360337/6528d9f63ec045c9abbdfc5eed03d874.svg',
                quote:
                '//cdn.optimizely.com/img/15841360337/5af81438c2bc40bcbe448d6973d649bd.png',
                brochure:
                '//cdn.optimizely.com/img/15841360337/8923ac5a4ad8459f825dccbc91a56ef3.png'
            },
            IMPREZA: {
                Mob_dealer:
                '//cdn.optimizely.com/img/15841360337/9cdbe34f47274c83b95d3be94c22804b.svg',
                Mob_quote:
                '//cdn.optimizely.com/img/15841360337/66d86ca3aff64d23ab8269a619d1dd4a.png',
                Mob_broucher:
                '//cdn.optimizely.com/img/15841360337/caa881050bdf4fdc85f547c512cfc926.png',
                modelName: 'IMPREZA',
                hero1:
                '//cdn.optimizely.com/img/15841360337/efc3bbc96f1a47e6b123cf9548850271.png',
                hero2: '',
                Mob_hero1:
                '//cdn.optimizely.com/img/15841360337/ecc21e6a94b843ea9f84f5b6322de7d6.png',
                dealer:
                '//cdn.optimizely.com/img/15841360337/6528d9f63ec045c9abbdfc5eed03d874.svg',
                quote:
                '//cdn.optimizely.com/img/15841360337/406a54225e254ca9a2c7f3c3c0b20a96.png',
                brochure:
                '//cdn.optimizely.com/img/15841360337/6dbe9cb67f474ad68601b9ddf5780a1f.png'
            },
            WRX: {
                Mob_dealer:
                '//cdn.optimizely.com/img/15841360337/9cdbe34f47274c83b95d3be94c22804b.svg',
                Mob_quote:
                '//cdn.optimizely.com/img/15841360337/8e1a61eb25c7421c8073f182f28dadb9.png',
                Mob_broucher:
                '//cdn.optimizely.com/img/15841360337/e745bdc0ff01457aaf60136a3a5ba8f8.png',
                modelName: 'WRX',
                hero1:
                '//cdn.optimizely.com/img/15841360337/cf3d7d30efd34ad68739b035085bc1ce.png',
                hero2: '',
                Mob_hero1:
                '//cdn.optimizely.com/img/15841360337/90e538ebf62a4a60a6224e7f4d44c381.png',
                dealer:
                '//cdn.optimizely.com/img/15841360337/6528d9f63ec045c9abbdfc5eed03d874.svg',
                quote:
                '//cdn.optimizely.com/img/15841360337/39ea47a6f8f948b3ae6616a507fdc0da.png',
                brochure:
                '//cdn.optimizely.com/img/15841360337/d4fc00f626a346c899c6eee955a567ad.png'
            },
            BRZ: {
                Mob_dealer:
                '//cdn.optimizely.com/img/15841360337/9cdbe34f47274c83b95d3be94c22804b.svg',
                Mob_quote:
                '//cdn.optimizely.com/img/15841360337/931d33f8cd29477299b24ddc98890cd9.png',
                Mob_broucher:
                '//cdn.optimizely.com/img/15841360337/3f171a44fdf74312a80ed5d95c73f0eb.png',
                modelName: 'BRZ',
                hero1:
                '//cdn.optimizely.com/img/15841360337/89dcf1888b864cf8bd7c1b92d4679505.png',
                hero2: '',
                Mob_hero1:
                '//cdn.optimizely.com/img/15841360337/2770efe43ed04d03b32fa0e08c1cbf82.png',
                dealer:
                '//cdn.optimizely.com/img/15841360337/6528d9f63ec045c9abbdfc5eed03d874.svg',
                quote:
                '//cdn.optimizely.com/img/15841360337/58cc3851b1e44a10a7a2a893abdce1cf.png',
                brochure:
                '//cdn.optimizely.com/img/15841360337/75ae63bbc37a4beb84f72355b98f1087.png'
            }
        };

        const modelConfig = modelName ? modelMapping[modelName] : null;
        const displayModelName = (modelConfig && modelConfig.modelName)
        || (modelName ? modelName.toUpperCase() : 'MODEL');
        ...
        const buildPriceURL = (modelName && buildPriceURLs[modelName])
    || 'https://www.subaru.co.nz/configure';
        ...
        const helpText = isMobile
            ...
            : `GET ALL THAT'S NEW, FROM SUBARU ${displayModelName}?`;

        // Hero images - OUTBACK has 2, CROSSTREK has 1
        // Use mobile images on mobile, desktop images on desktop
        const hero1Img = (isMobile && modelConfig && modelConfig.Mob_hero1)
        || (modelConfig && modelConfig.hero1)
        || '//cdn.optimizely.com/img/15841360337/49f337a165b447fdb4e0c25b3c4ce40c.png';
        const hero2Img = (isMobile && modelConfig && modelConfig.Mob_hero2)
        || (modelConfig && modelConfig.hero2)
        || null;

        const buildImg = (isMobile && modelConfig && modelConfig.Mob_dealer)
        || (modelConfig && modelConfig.dealer)
        || buildIcon;

        const testImg = (isMobile && modelConfig && modelConfig.Mob_test)
        || (modelConfig && modelConfig.test)
        || testIcon;

        const quoteImg = (isMobile && modelConfig && modelConfig.Mob_quote)
        || (modelConfig && modelConfig.quote)
        || testIcon;
