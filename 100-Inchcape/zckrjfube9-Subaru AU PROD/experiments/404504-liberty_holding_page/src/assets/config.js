...
const modelData = {
        wrx: {
            ...
            bullets: [
                '2.0-litre injected, turbocharged horizontally-opposed Boxer 4-cylinder, petrol engine',
                '197kW @ 5600rpm',
                '350Nm @ 2400-5200rpm'
            ],
        ...
        impreza: {
            ...
            bullets: [
                '2.0-litre horizontally-opposed Boxer 4-cylinder, petrol engine',
                '115kW @ 6000rpm',
                '196Nm @ 4000rpm'
            ],
        ...
        forester: {
            ...
            bullets: [
                '2.5-litre horizontally-opposed Boxer 4-cylinder, petrol engine',
                '136kW @ 5800rpm',
                '239Nm @ 4400rpm'
            ],
...
function bindIntroToggle(root) {
        ...
        function toggleIntro() {
            if (introIsHidden) {
                ...
                root.querySelector('.liberty-intro__para--two').classList.add('nr-hidden');
                introIsHidden = true;
            }
        }
...
function bindAwardsToggle(root) {
        ...
        function toggleAwards() {
            if (introIsHidden) {
                ...
                button.querySelector('p').textContent = 'View More';
                button.querySelector('span').classList.remove('rotate');
                root.querySelector('.liberty-awards__section-two').classList.add('nr-hidden');
                introIsHidden = true;
            }
        }
